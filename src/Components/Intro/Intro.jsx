    ...
    <div className='intro'>
      <div className="i-left">
        <div className="i-name">
          <span className="">Hy! I Am</span>
          <span className="">Pradeepooshan</span>
          <span className="">Frontend Developer with high level of experience in web designing and development producting the Quality work</span>
        </div>
